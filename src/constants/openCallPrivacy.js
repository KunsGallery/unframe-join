// TODO: 실제 운영 전 개인정보처리자명, 담당부서, 연락처, 시행일을 확정해 교체해야 함.
export const OPEN_CALL_PRIVACY_TEXT = `회사명(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.
