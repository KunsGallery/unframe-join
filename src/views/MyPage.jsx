...
const MyPage = ({ applications, handleReturn }) => (
  <section className="animate-in fade-in py-20 min-h-screen relative z-10 px-4">
    <div className="flex justify-between items-end mb-20">
      ...
      <button
        ...
        className="text-xs font-black uppercase tracking-widest text-zinc-400 hover:text-[#004aad] transition-colors"
      >
        ← Back to Main
      </button>
    </div>
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-start gap-10">
              <div className="flex-1 space-y-6">
                ...
                <h3 className="text-3xl md:text-5xl font-black uppercase text-zinc-900 leading-tight break-words">
                  {app.exhibitionTitle}
                </h3>

                {app.status === "rejected" && app.rejectionReason && (
                  <div className="bg-red-50 p-8 rounded-[40px] border border-red-100 space-y-3 animate-in slide-in-from-top-4">
