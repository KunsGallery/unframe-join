...
const MusicSearchField = ({ field, value, onChange }) => {
  ...
  return <div className="rounded-2xl border-2 border-zinc-200 p-4 sm:col-span-2">
    ...
    <form onSubmit={submit} className="mt-6 rounded-[36px] border-2 border-zinc-900 bg-white p-6 shadow-[8px_8px_0px_#000] md:p-10">
      ...
      <div className="mt-8 grid gap-5 sm:grid-cols-2">
        ...
        {(event.formSettings?.customFields || []).map((field) => {
          ...
          if (field.type === "music") return <MusicSearchField key={field.id} field={field} value={value || {}} onChange={setCustomValue} />;
