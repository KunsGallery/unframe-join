...
const SalonDetail = ({ slug, user, applications = [], onBack, onApply, onViewApplication }) => {
  ...
  const copyAccountNumber = async () => {
    if (!hasText(payment.accountNumber)) return;
    try {
      await navigator.clipboard.writeText(payment.accountNumber.trim());
      setCopyState("copied");
